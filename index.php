<?php
$db = require 'db.php';
$items=$db->query("SELECT id, name, category, time_needs FROM recipes WHERE id<=3")->fetchAll(PDO::FETCH_ASSOC);
?>
<!doctype html>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center">
                        <div class="recepie_thumb">
                            <img src="img/recepie/reccepie_<?= $item['id']?>.png" alt="">
                        </div>
                        ...
                        <a href="recipes_details.php" class="line_btn">View Full Recipe</a>
                    </div>
                </div>
                <?php endforeach;?>
